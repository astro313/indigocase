...
plt.hist(red[plant_bool].flatten(), bins=50)
plt.title('plants in Red channel histogram')
plt.show();

plt.hist(datasetTrain.read(2)[plant_bool].flatten(), bins=50)
plt.title('plants in green channel histogram')
plt.show();

plt.hist(datasetTrain.read(3)[plant_bool].flatten(), bins=50)
plt.title('plants in blue channel histogram')
plt.show();

plt.hist(datasetTrain.read(4)[plant_bool].flatten(), bins=50)
...
rnb_dog = rnb - ndi.gaussian_filter(rnb, 15) # difference of gaussians
